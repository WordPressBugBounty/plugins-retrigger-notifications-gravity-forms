...
class GF_Retrigger_Funtions {
	...
	/**
	 * Render a minimal support banner at the bottom of meta boxes.
	 *
	 * @return void
	 */
	static public function render_support_banner() {
		$subject = rawurlencode( 'Support Request - Retrigger Notifications Gravity Forms' );
		?>
		<div style="margin-top: 12px; padding: 8px 10px; background: #f0f0f1; border-left: 3px solid #2271b1; font-size: 12px; line-height: 1.4;">
			<?php esc_html_e( 'Not working as expected, or something missing?', 'gf-retrigger' ); ?>
			<a href="mailto:hello@wpspins.com?subject=<?php echo esc_attr( $subject ); ?>" style="white-space: nowrap;"><?php esc_html_e( 'Reach out to us so we can help.', 'gf-retrigger' ); ?></a>
		</div>
		<?php
	}
